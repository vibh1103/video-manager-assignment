...
export const findUniqueVideo = async (id: number): Promise<Video | undefined> => {
...
export const findMultipleVideo = async (ids: number[]): Promise<Video[] | undefined> => {
...
export const createSharedLink = async ( shareLink: Partial<SharedLink> ): Promise<SharedLink> => {
...
export const findUniqueSharedLink = async (id: number): Promise<(SharedLink & {video: Video}) | undefined> => {
